...
Validate.prototype = {
  ...
  action: function () {
    ...
    if (action === "versions") {
      if (!this.argv.root) {
        this._fail("Requires a project `--root` path");
      }
    }
...
module.exports = {
  parse: function () {
    return yargs
      ...
      .option("root", {
        alias: "r",
        describe: "Project root (for `node_modules` introspection)",
        type: "string",
        default: process.cwd() // TODO: Consider removing this an blowing up if not set.
      })
